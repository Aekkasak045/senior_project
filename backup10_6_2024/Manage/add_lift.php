...
<table>
    ...
    <tr><td>Lift Name:</td><td><input type="text" name="lift_name" size="20"></td></tr>
    <tr><td>MAC Address:</td><td><input type="text" name="mac_address" size="20"></td></tr>
    <tr><td>Max Level:</td><td><input type="text" name="max_level" size="4"></td></tr>
    <tr><td>Floor Name:</td><td><input type="text" name="floor_name" size="40"></td></tr>
