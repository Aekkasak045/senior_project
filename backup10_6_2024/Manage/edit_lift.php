...
<table>
    ...
    <tr><td>Lift Name:</td><td><input type="text" name="lift_name" size="20" value="<?php print($lift["lift_name"]);?>"></td></tr>
    <tr><td>MAC Address:</td><td><input type="text" name="mac_address" size="20" value="<?php print($lift["mac_address"]);?>"></td></tr>
    <tr><td>Max Level:</td><td><input type="text" name="max_level" size="4" value="<?php print($lift["max_level"]);?>"></td></tr>
    <tr><td>Floor Name:</td><td><input type="text" name="floor_name" size="40" value="<?php print($lift["floor_name"]);?>"></td></tr>
